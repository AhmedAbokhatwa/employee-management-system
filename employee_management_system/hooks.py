...
app_publisher = "managing companies, departments, and employees. The system will allow users to create, read, update, and delete"
app_description = "Employee Management System that encompasses various features for"
